...
\*Data quality notes: To Double Check Danielle Ulrich - apoplastic fractions \>1, German Vargas - Species with crazy totRWCtlp and other values,Chris M. Smith-Martin - CFT calculation off.
...
Analyzed and ordered based on the factors to consider
...
\*TLP mean for TSL is around -2 except for bamboo, with the greatest variance & range for trees. Trees possibly have adaptive qualities that allow for TLP to be much lower. SWC shows similar means, possibly relative to TLP for the purpose of clearly identifying the water content relationship to TLP.
...
Biomes are considered next since TSL did not show an average mean throughout for a closer relationship (other graphs area at the end to look over).
...
\*SWC does not have a consistent mean across biome but SWA does. TLP area calculation has an average mean too, and [RWC\@TLP](mailto:RWC@TLP){.email} is not looking to bad as well except for tropical moist.
...
Next, accounting for the differences between other factors. Angiosperms and Gymnosperms could have a different impact on how the water content is looked at.
...
Starting with SWC and SWA then looking at the other variables, biomes are considered for the relationships possible.
...
\
\### Look at some of the same attributes per biome and leaf habit -removed Picea mariana because massive high outlier
...
\
\# Putting it together: PV curves we can 'see' from RS This is the actual relationship between water potential and absolute g water content (per m2 leaf area). This assumes identical LAI or the viewing of a single leaf.
...
\
\
\# \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ \# And the Methodological elephant in the room: Rehydration
...
Can we predict a leaf's characteristics from other characteristics of it? (when those characteristics aren't mathmatically related) - Not really. - The previously hypothesized correlation between TLP and SWC/LDMC isn't great
...
Storing all other graphs looked over in order presented above
