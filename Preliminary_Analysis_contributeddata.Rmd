...
Still missing 160 families somehow, but will go back and fix those
...
palette(mypal)
par(mar=c(6,6,2,1))
plot(SWA~SWC, fullpvs, pch=16, col="grey", log="xy", ylab="Sat g water per m2\nArea Basis", xlab="Sat g Water per g dry mass\nMass Basis")
palette(mypal)
